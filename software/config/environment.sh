#!/bin/bash
# edit FOMPUSHDATA_BASE=$HOME/fompushdata to your push data directory
...
set_fompush_base()
{
  ...
  export CPUSHDATA_BASE=$CPUSH_BASE/../fompushdata
...
setup_fompush()
{
  ...
  export CLASSPATH=$CLASSPATH:/usr/local/share/java/lcm.jar:$CPUSH_BASE/software/build/share/java/lcmtypes_fompush_lcmtypes.jar
  ...
  export GUROBI_HOME=$HOME/software/gurobi701/linux64/matlab
}
...
set_ros()
{
  ...
  export ROS_PACKAGE_PATH=$HOME/fompush/ros_ws/:$ROS_PACKAGE_PATH
}
...
alias pythonfompush='ipython -i -c "run $CPUSH_BASE/catkin_ws/src/fompush_config/python/pythonfompush.py"'

alias pman='bot-procman-sheriff -l $CPUSH_BASE/software/config/fompush.pmd'
